 ...
 */
public class ScoreFragment extends BaseFragment<ScoreContract.View, ScorePresenter> implements ScoreContract.View, SwipeRefreshLayout.OnRefreshListener, BaseReAdapter.OnItemClickListener {
